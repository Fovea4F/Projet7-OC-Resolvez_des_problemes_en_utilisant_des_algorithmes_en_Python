...
print(f"AUn investissement dans cette lite d'actions {bestInvestActionsList}, permet un gain de {acquiredRoiAmount} € pour une acquisition e {bestInvestAmount} €, afin d'acquérir la somme de ")
