...
acquiredAmount = combination[bestInvestIndex][1]
                   ...
                   bestInvestActionsList =  = 
print(f"Afin de maximiser les profits, vous devers investir dans la combinaison suivante : {bestInvestActionsList}, pour une acquisition de {bestInvestAmount}, afin d'acquerir la somme de  a")