...
acquiredAmount = combination[bestInvestIndex][1]
                   ...
                   print(f"Afin de maximiser les profits, vous devers investir dans la combinaison suivante : {bestInvestActionsList}, pour une acquisition de {bestInvestAmount} €, afin d'acquérir la somme de {acquiredAmount} €")