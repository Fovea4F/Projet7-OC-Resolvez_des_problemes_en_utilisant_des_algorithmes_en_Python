...
print(f"AUn investissement dans cette lite d'actions {bestInvestActionsList}, permet un gain de {acquiredRoiAmount} € pour une acquisition de {bestInvestAmount} €")
