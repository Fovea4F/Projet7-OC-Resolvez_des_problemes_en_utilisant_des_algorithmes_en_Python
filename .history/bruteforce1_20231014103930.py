...
for index in range(0:les(combinations)[bestInvestIndex]:
    bestInvestActionsList.append(combination[bestInvestIndex][0][0])
bestInvestAmount = combination[bestInvestIndex][1]
for index in range(combinations[bestInvestIndex]:
    bestInvestAmount += combinations[bestInvestIndex][1]append(combination[bestInvestIndex][0][0])

                   bestInvestActionsList =  = 
print(f"Afin de maximiser les profits, vous devers investir dans la combinaison suivante : {combinations[bestInvestIndex][0], }")