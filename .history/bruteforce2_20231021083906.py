...
print("="*80)
for row in range(len(valuedStockList)):
    stockName = valuedStockList[row][0]
    stockValue = valuedStockList[row][1]
    stockProfit = valuedStockList[row][2]
    print("=== {:<3}{:<31}{:<27}{:<12}===".format('',stockName, stockValue, round(stockProfit, 2)))
    print(f"==={'-'*74}===")
print("=== {:<28}{:<28}{:<17}===".format(Bénéfices maximisés attendus'"Nom de l'action", "Acquisition (en €)", "Bénéfices en €"))
print()
