...
acquiredAmount = combination[bestInvestIndex][1]
                   ...
                   imiser les profits, vous devers investir dans la combinaison suivante : {bestInvestActionsList}, pour une acquisition de {bestInvestAmount} €, afin d'acquérir la somme de {acquiredAmount} €")