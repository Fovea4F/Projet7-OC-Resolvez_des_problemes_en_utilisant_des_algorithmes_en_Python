...
print(f"Un investissement dans la liste d'actions {bestInvestActionsList},\
 permet un gain de {"{0:.2f}.format(acquiredRoiAmount)} € pour une acquisition\
de {0:.2f}.format{bestInvestAmount} €, soit une rentabilité de {0:.2f}.format{acquiredRoiAmount/bestInvestAmount*100}")
