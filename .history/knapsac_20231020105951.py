...
calculatedActionList, profitbruteForceKnapSac(valuedStockList, maxInvestAmount)
end = perf_counter_ns()
print(f"Liste optimisée d'investissement : {}, bénéfice réalisé attendu : {optimisé}")
